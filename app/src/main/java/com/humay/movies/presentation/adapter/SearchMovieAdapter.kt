...
import com.humay.movies.databinding.ItemSearchMovieBinding
...
class SearchMovieAdapter(private val listener: OnItemClickListener) :
    ListAdapter<Movie, SearchMovieAdapter.MoviesViewHolder>(DIFF_CALL_BACK) {
    ...
    inner class MoviesViewHolder(private val _binding: ItemSearchMovieBinding) :
